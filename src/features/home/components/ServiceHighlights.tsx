...
const ServiceHighlights = () => {
  ...
  const scroll = (direction: 'left' | 'right') => {
    if (carouselRef.current) {
      ...
      const cardWidth = clientWidth; // Use full viewport width for mobile-friendly sliding
  ...
  useEffect(() => {
    if (isInView && carouselRef.current) {
      ...
      // Images will be lazy loaded by the browser's native loading="lazy" attribute
